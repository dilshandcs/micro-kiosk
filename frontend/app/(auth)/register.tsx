...
export default function RegisterScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Buttons */}
      <Button title={t('register.screen.button.register')} onPress={handleRegister} testID='register-button-register' />
      <Button title={t('register.screen.button.login')} testID='register-button-login' onPress={() => router.replace('/login')} />
    </View>
  );
}
